...
nogui = False
net_file = './data/a.net.xml'
rou_file = './data/a.rou.xml'
sumocfg_file = './data/a.sumocfg'
...
def main(argv):
    ...
    # traci.start([sumoBinary, "-c", options.sumocfg_file,"--tripinfo-output","tripinfo.xml"])
    traci.start([sumoBinary, '-n', net_file, '-r', rou_file])
